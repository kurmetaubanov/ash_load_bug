defmodule AshLoadBugWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AshLoadBugWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AshLoadBugWeb.Gettext, "errors", msg, opts)
    end
  end
